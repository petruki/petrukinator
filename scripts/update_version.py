...
def main():
  ...
  plistpath = scriptpath + "/resources/Petrukinator-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Petrukinator-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Petrukinator-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Petrukinator-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Petrukinator-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/Petrukinator.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/Petrukinator.iss",inplace=1):
