...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=Petrukinator Demo Installer\n"
      else:
        line="OutputBaseFilename=Petrukinator Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the Petrukinator Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the Petrukinator installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=Petrukinator Demo installer\n"
     else:
       line="SetupWindowTitle=Petrukinator installer\n"
